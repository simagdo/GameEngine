package de.simagdo.engine.camera;

import de.simagdo.engine.input.Input;
import de.simagdo.engine.window.Window;
import de.simagdo.math.Matrix4f;
import de.simagdo.math.Quaternion;
...
public class Camera {
    ...
    public void update() {
        ...
        if (Input.getInstance().isButtonHolding(2)) {
            ...
            glfwSetCursorPos(Window.getInstance().getWindow(), Input.getInstance().getLockedCursorPosition().getX(), Input.getInstance().getLockedCursorPosition().getY());
        }
